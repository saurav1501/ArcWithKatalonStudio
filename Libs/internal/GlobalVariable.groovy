...
Profile QAS-IND-MEM : Explicit Wait Timeout
...
Profile QAS-IND-MEM : Adding India projects
...
Profile QAS-IND-MEM : Adding new team member 
...
Profile QAS-IND-MEM : Adding Credit Card payment details 
...
Profile QAS-IND-MEM : Adding new  india city projects 
...
Profile QAS-IND-MEM : Adding new Inida community projects 
...
Profile STG-IND  : Adding new Inida community projects </p>
    ...
    static {
        ...
        allVariables.put('STG-US', allVariables['default'] + ['url' : 'http://www.stg.arconline.io/', 'userName' : 'Saurav@groupten.com', 'password' : 'LEEDg10', 'timeOut' : 40, 'env' : 'stg', 'BuildingSheet' : 'USBuildingProject', 'BuildingTeam' : 'BTeam', 'CCPayment' : 'Payment', 'rowNumTwo' : 2, 'rowNumThree' : 3, 'rowNumFour' : 4, 'rowNumFive' : 5, 'rowNumSix' : 6, 'CitySheet' : 'USCityProject', 'CommunitySheet' : 'USCommunityProject', 'CDataInput' : 'CDataInput', 'PortfoliosSheet' : 'Portfolio'])
